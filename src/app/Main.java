            ...
            try {
                switch (opcao) {
                    ...
                    case 2:
                        ...
                        if (t == null) {
                            System.out.println("Não há transportes disponíveis no momento. Cadastre mais veículos.");
                        } else {
                ...
                System.out.println("Erro de formatação numérica. Por favor, certifique-se de digitar números onde solicitado.");
            } catch (Exception e) {
